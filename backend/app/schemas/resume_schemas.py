...
class Experience(BaseModel):
    ...
    end_date: Optional[str] = Field(None, description="End date of employment (YYYY-MM)")
...
class ResumeCreate(BaseModel):
    ...
    experience: List[Experience] = Field(..., description="List of work experience entries")
...
class EnhancedResume(BaseModel):
    ...
    skill_suggestions: List[str] = Field(..., description="Suggested additional skills based on experience")
    improvements: List[str] = Field(..., description="Suggested improvements for the resume")
